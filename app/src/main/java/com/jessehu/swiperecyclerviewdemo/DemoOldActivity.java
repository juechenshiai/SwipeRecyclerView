...
public class DemoOldActivity extends AppCompatActivity {
    ...
    private void setListener() {
        mSwipeAdapter.setOnMenuItemClickListener((view, itemPosition, menuPosition) -> Toast.makeText(mContext, mTitles.get(menuPosition) + mContents.get(itemPosition), Toast.LENGTH_SHORT).show());
